...
import { MedicalTestListRelationFilter } from "../../medicalTest/base/MedicalTestListRelationFilter";
...
class DoctorWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => MedicalTestListRelationFilter,
  })
  @ValidateNested()
  @Type(() => MedicalTestListRelationFilter)
  @IsOptional()
  @Field(() => MedicalTestListRelationFilter, {
    nullable: true,
  })
