...
@InputType()
class MedicalTestCreateNestedManyWithoutDoctorsInput {
...
export { MedicalTestCreateNestedManyWithoutDoctorsInput as MedicalTestCreateNestedManyWithoutDoctorsInput };
