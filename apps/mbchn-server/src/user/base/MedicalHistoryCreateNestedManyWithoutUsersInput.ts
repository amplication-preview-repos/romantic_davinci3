...
@InputType()
class MedicalHistoryCreateNestedManyWithoutUsersInput {
...
export { MedicalHistoryCreateNestedManyWithoutUsersInput as MedicalHistoryCreateNestedManyWithoutUsersInput };
