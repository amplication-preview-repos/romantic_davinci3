...
@InputType()
class TransactionUpdateManyWithoutMedicalTestsInput {
...
export { TransactionUpdateManyWithoutMedicalTestsInput as TransactionUpdateManyWithoutMedicalTestsInput };
